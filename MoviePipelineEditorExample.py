...
'''
def OnIndividualJobFinishedCallback(inJob, success):
...
def RenderQueue_ViaDuplication():
    ...
    NewExecutor.on_individual_job_finished_delegate.add_callable_unique(OnIndividualJobFinishedCallback) # Only available on PIE Executor
